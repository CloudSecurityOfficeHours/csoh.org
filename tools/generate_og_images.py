...
PAGES = [
    ("index.html",
     ...
     "2,000+ practitioners. 610+ resources. Free weekly Zoom. No trackers.",
     "Community"),
    ...
    # these titles on purpose: the text is baked into a JPG, so a number here
    # goes stale silently and no gate reads pixels.
    ("resources-ctf-challenges.html",
     "CTF Challenges & Vulnerable Labs",
     "Deliberately broken AWS, Azure, GCP and Kubernetes environments to attack and defend.",
     "Directory"),
    ("resources-labs-training.html",
     "Hands-On Cloud Security Labs",
     "Interactive labs and training platforms for building real cloud security skill.",
     "Directory"),
    ("resources-security-tools.html",
     "Cloud Security Tools & Platforms",
     "CNAPP, CSPM, KSPM, SIEM and the rest of the tooling landscape, vendor-neutral.",
     "Directory"),
    ("resources-certifications.html",
     "Cloud Security Certifications",
     "CCSK, CCSP, CKS and the cloud-specific certification paths, compared without vendor spin.",
     "Directory"),
    ("resources-ai-security.html",
     "AI Security & LLM Protection",
     "Securing AI and LLM systems: prompt-injection defenses, red-teaming, and AI governance.",
     "Directory"),
    ("resources-job-search.html",
     "Cloud Security Jobs & Careers",
    ...
    ("threat-research.html",
     ...
     "Defender Resource"),
    ("meetings.html",
     "113 Weekly Cloud Security Recaps",
     "Topic-by-topic notes from every CSOH Friday session - 113 meetings searchable by speaker and topic.",
     "Archive"),
    ("faq.html",
    ...
    ("about.html",
     ...
     "A free, vendor-neutral community for cloud security pros: what CSOH is, why it exists, and how it's built in the open.",
     "Community"),
    ("mentorship.html",
     "Mentorship at CSOH",
     "How peer mentoring happens in the Friday Zoom and Signal chat, and how to find a mentor or mentee.",
     "Community"),
    ("news.html",
     "Cloud Security News",
    ...
    ("human-risk.html",
     ...
     "Why role predicts behaviour poorly, how phishing, BEC, vishing and AI-assisted campaigns arrive, and which signals detect them.",
     "Guide"),
