...
PAGES = [
    ("index.html",
     ...
     "2,000+ practitioners. 390+ resources. Free weekly Zoom. No trackers.",
     "Community"),
    ...
    ("threat-research.html",
     ...
     "Defender Resource"),
    ("meetings.html",
     "102 Weekly Cloud Security Recaps",
     "Topic-by-topic notes from every CSOH Friday session - 102 meetings searchable by speaker and topic.",
     "Archive"),
    ("faq.html",
