...
PAGES = [
    ...
    ("how-csoh-org-is-secured.html",
     ...
     "Security"),
    ("breach-lessons.html",
     "Lessons From 10 Cloud Breaches",
     "Ten real cloud breach kill chains, boiled down to the recurring root causes. Learn the initial-access patterns that keep working and the controls...",
     "Analysis"),
