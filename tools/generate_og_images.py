...
PAGES = [
    ("index.html",
     ...
     "2,000+ practitioners. 460+ resources. Free weekly Zoom. No trackers.",
     "Community"),
    ...
    ("threat-research.html",
     ...
     "Defender Resource"),
    ("meetings.html",
     "108 Weekly Cloud Security Recaps",
     "Topic-by-topic notes from every CSOH Friday session - 108 meetings searchable by speaker and topic.",
     "Archive"),
    ("faq.html",
