...
# around the clock (three data centers, one probe about every 100 seconds),
# which is enough to keep a scale-to-zero service from ever reaching zero. A QA origin behind a monitor
