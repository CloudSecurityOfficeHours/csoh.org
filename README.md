...
| Resource | What it is |
|---|---|
| 🛡️ [Resources Directory](https://csoh.org/resources.html) | <!--count:resources_floor-->640+<!--/count--> tools, labs, CTFs, certifications - top-level nav link, auto-refreshed weekly |
...
Comprehensive catalog of **<!--count:resources_floor-->640+<!--/count--> cloud security resources** organized by <!--count:resource_categories-->7<!--/count--> categories:
