...
| Resource | What it is |
|---|---|
| 🛡️ [Resources Directory](https://csoh.org/resources.html) | <!--count:resources_floor-->430+<!--/count--> tools, labs, CTFs, certifications - top-level nav link, auto-refreshed weekly |
...
Comprehensive catalog of **<!--count:resources_floor-->430+<!--/count--> cloud security resources** organized by 6 categories:
