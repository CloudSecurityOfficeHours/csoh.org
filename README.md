...
| Resource | What it covers |
|---|---|
| 📝 [Meeting Recaps](https://csoh.org/meetings.html) | <!--count:meetings-->112<!--/count--> weekly session recaps, searchable |
...
- **<!--count:meetings-->112<!--/count--> meeting recaps** with per-topic summaries and speaker notes
...
├── meetings.html               # Weekly meeting recaps (112 entries, topic-by-topic)
...
- ✅ **`sitemap.xml`** - <!--count:sitemap_urls-->281<!--/count--> URLs, `<lastmod>` refreshed from git commit dates on every deploy ([tools/update_sitemap.py](https://github.com/CloudSecurityOfficeHours/csoh.org/blob/main/tools/update_sitemap.py))
